...
public class GoogleCalendarService {
    ...
    public Event addEventManual(@NonNull String calendarId) throws IOException{
        ...
        event.setReminders(reminders);
         ...
         calendarId = "ihebsad1998@gmail.com";
     ...
     * @throws IOException when an error occurs in the HTTP request
     */
    public Event addEventToCalendar(@NonNull tn.esprit.project.Entities.Event e ) throws IOException{
        Event event = new Event()
                .setSummary(e.getTitle())
                .setLocation("Tunisia")
        ...
        String calendarId = "ihebsad1998@gmail.com";
        event = googleCalendar.events().insert(calendarId, event).execute();
        System.out.printf("Event created: %s\n", event.getHtmlLink());
        return event;
